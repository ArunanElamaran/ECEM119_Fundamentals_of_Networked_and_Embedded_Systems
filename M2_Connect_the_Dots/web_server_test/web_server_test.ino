// Source: https://docs.arduino.cc/tutorials/nano-rp2040-connect/rp2040-web-server-rgb/

#include <SPI.h>
#include <WiFiNINA.h>

///////please enter your sensitive data in the Secret tab/arduino_secrets.h
char ssid[] = "NoonyPhone";        // your network SSID (name)
char pass[] = "applesauce32";    // your network password (use for WPA, or use as key for WEP)
